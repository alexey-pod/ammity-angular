<section class="content-main">
	...
	<div 
		...
		class="become-box" style="margin-bottom:0;padding-bottom:0;">
	</div>
	...
	<div class="page_form  ">
		...
		<table class="form_table">
			...
			<tr ><!--sd_customer_base-->
				<td class="name label">
					<label for="customer_base">наработанная база клиентов:</label>
				</td>
				<td class="value">
					<input ng-model="form.customer_base" id="customer_base" type="checkbox" class="type-checkbox" />
				</td>
			</tr>
			<tr ><!--sd_service_center-->
				<td class="name label">
					<label for="service_center">собственный сервисный центр:</label>
				</td>
				<td class="value">
					<input ng-model="form.service_center" id="service_center" type="checkbox" class="type-checkbox" />
				</td>
			</tr>
			<tr ><!--Отправить-->
				<td class="name"></td>
